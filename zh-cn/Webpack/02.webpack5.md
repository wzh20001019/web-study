...
yarn add eslint-loader eslint eslint-config-airbnb-base eslint-plugin-import -D   // 对 js 配置进行检查

yarn add purgecss-webpack-plugin -D          // 去除无用的 css 样式包
```
