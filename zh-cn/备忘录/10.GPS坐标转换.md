...
export const GPS_UTILS = {
  ...
  gcj_encrypt: function (wgsLat: number, wgsLon: number) {
    ...
    return {
      lat:
        parseFloat(wgsLat as unknown as string) +
        parseFloat(d.lat as unknown as string),
      lon:
        parseFloat(wgsLon as unknown as string) +
        parseFloat(d.lon as unknown as string)
    }
  },
  //GCJ-02 to WGS-84
